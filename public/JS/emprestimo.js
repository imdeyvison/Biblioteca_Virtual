...
let botaoEmprestar = document.getElementById('botao_emprestar');
let inputTitulo = document.getElementById('loan-title');
let inputUsuario = document.getElementById('loan-user');
let inputData = document.getElementById('loan-date');
let listaEmprestimos = document.getElementById('loan-list');
let botaoDevolver = document.getElementById('botao_devolver');
let inputTituloDevolucao = document.getElementById('return-title');
